...
<body >
	<div id="header">
		<ul><h2 style=" font-family:Verdana; font-size: 40px;color:#000000; float: center;">Spark Foundation Internship Project</h2></ul>
       <br>
       <img src="sparks.png">
       <h2 style=" font-family:Verdana; font-size: 40px;color:#000000; float: center;">Basic Banking System</h2>
    </div>
        <div id="section">
            <table>
                <tr></tr>
            ...
            <br><br><br><br>
            <h4 style="text-align: right;">-by MADHAVAN.K.P</h4>
    </div>
